...
float angleExp[4];
angleExp[0] = 0.0;
angleExp[1] = -62.12 * PI_/180; // From CAD
angleExp[2] = 62.12 * PI_/180; // From CAD
angleExp[3] = 0.0;
...
if(startControl == 1){
m2 = rampGainWheel  * tau_wheel_R;
m8 = rampGain *  tau_rHip;
m9 = -rampGain * tau_lHip; // Flip signs to go back to left leg convention
m1 = - rampGainWheel * tau_wheel_L; // Flip signed to go back to left lef convention
}
